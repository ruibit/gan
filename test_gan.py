...
for epoch in range(num_epoch):
    for i, mini_batch in enumerate(dataloader):
        gt_images, _ = mini_batch  # 获取真实图像，忽略标签
        ...
        if i % 400 == 0:
            ...
            torchvision.utils.save_image(image, os.path.join(save_dir, f"image_{len(dataloader) * epoch + i}.png"), nrow=4)
